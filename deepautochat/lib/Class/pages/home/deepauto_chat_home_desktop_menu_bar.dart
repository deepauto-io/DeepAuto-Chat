...
class DeepautoChatHomeDesktopMenuBar extends StatelessWidget {
  const DeepautoChatHomeDesktopMenuBar({super.key});
  @override
            ...
            children: [
              ...
              Container(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular((8.0)),
                  onTap: () {
                    DeepautoChatURLUnit.openGithub();
                  },
                  child: Center(
                    child: Text(
                      "Documentation",
              ...
              Container(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular((8.0)),
                  onTap: () {
                    DeepautoChatURLUnit.openTwitter();
                  },
                  child: Center(
                    child: Image.asset(
